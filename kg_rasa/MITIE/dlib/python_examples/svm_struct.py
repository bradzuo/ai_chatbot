...
# needed to setup a structural SVM models for your machine learning problems.  To
...
# multi-class classifier models and then walk through using the structural SVM
# tools to find the parameters of this classification models.     As an aside,
...
def main():
    ...
    # learn the parameters of our 3-class classifier models.  The details of this
...
def predict_label(weights, sample):
    ...
    # Our 3-class classifier models can be thought of as containing 3 separate
    ...
    # the popular one-vs-all multi-class classifier models.

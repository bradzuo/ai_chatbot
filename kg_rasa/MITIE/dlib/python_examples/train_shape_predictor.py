...
#
#   In particular, we will train a face landmarking models based on a small
#   dataset and then evaluate it.  If you want to visualize the output of the
#   trained models on some images then you can run the
#   face_landmark_detection.py example program with predictor.dat as the input
#   models.
#
#   It should also be noted that this kind of models, while often used for face
...
# Now make the object responsible for training the models.
...
# I'm also reducing the capacity of the models by explicitly increasing
...
# Now that we have a models we can test it.  dlib.test_shape_predictor()

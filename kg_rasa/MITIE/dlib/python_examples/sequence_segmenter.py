...
# sequences and use them to learn a sequence segmentation models.  In particular,
...
# models we can use it to find names in new sentences, as we will show.
#
...
# sequence segmentation models is some method for converting the elements of a
...
# set.  These parameters determine properties of the segmentation models we will
...
# Train a models.  The models object is responsible for predicting the locations
# of names in new sentences.
model = dlib.train_sequence_segmenter(training_sequences, segments, params)

# Let's print out the things the models thinks are names.  The output is a set
...
# We can also measure the accuracy of a models relative to some labeled data.
# This statement prints the precision, recall, and F1-score of the models

...
# input.  So we load the saved NER models first.
...
# many thousands of examples to create a high quality.txt relation detector.
#
...
# Again, note that you need much more training data than this to make high quality.txt

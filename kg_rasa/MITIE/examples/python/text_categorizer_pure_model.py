...
#    text_categorizer that produces smaller models files.  However, these
#    smaller files are dependent on some feature extractor file which must be
#    provided when the models is loaded, as you will see in this example.
#
...
# Now to load load the 'pure models' from disk we also pass the feature extractor filename
